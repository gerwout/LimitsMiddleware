namespace Owin
{
    ...
    public static partial class AppBuilderExtensions
    {
        ...
        public static IAppBuilder MaxBandwidthGlobal(this IAppBuilder app, int maxBitsPerSecond)
        {
            app.MustNotNull("app");

            return MaxBandwidthGlobal(app, () => maxBitsPerSecond);
        }
        ...
        public static IAppBuilder MaxBandwidthGlobal(this IAppBuilder app, Func<int> getMaxBitsPerSecond)
        {
            app.MustNotNull("app");

            app.Use(Limits.MaxBandwidthGlobal(getMaxBitsPerSecond));
            return app;
        }
    }
}
